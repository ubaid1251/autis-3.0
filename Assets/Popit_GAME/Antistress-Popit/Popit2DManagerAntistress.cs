...
public class Popit2DManagerAntistress : MonoBehaviour
{
    public GameObject CurrentBG, SelectionUI, EpopsSelectionUI, Home, ThemeButton, Can, completeDialoge, MM, InternetPanel;
    ...
    public static Popit2DManagerAntistress INSTANCE;
    ...
    void Start()
    {
        Popit2DManagerAntistress.Epopping = true;
    ...
    void StartToPlay()
    {
        ...
        CurrentBG = Levels[0].GetComponent<Popit2DAntistress>().BG;
        if (CurrentBG != null)
    ...
    IEnumerator AdsShow()
    {
        ...
        {
            //if (GoogleAdMobController.THIS.bannerView == null)
            //    GoogleAdMobController.THIS.RequestBannerAd(); //AdCallPosition
        }
        catch (System.Exception)
        {
        ...
        print("Epopit True Hona Chahiay" + Popit2DManagerAntistress.Epopping);
    ...
    {
        //GoogleAdMobController.THIS.ShowInterstitialAd(); //AdCallPosition
        CloseDialogeAnim(completeDialoge , Levels[num].GetComponent<Popit2DAntistress>().EnablePopit);
        // completeDialoge.SetActive(false);
        // Levels[num].GetComponent<Popit2D>().EnablePopit();
    }
    ...
    {
        Popit2DManagerAntistress.Epopping = false;
        mainScreenPanel.SetActive(false);
