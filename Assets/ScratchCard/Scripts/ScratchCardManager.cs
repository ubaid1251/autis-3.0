...
public class ScratchCardManager : MonoBehaviour
{
	...
	public float MaskProgressCutOffValue = 0.1f;
	...
	internal void Init() 
	{
		...
		//	SpriteCard0[ScratchCard.CountSprite].SetActive(true);
            ...
            //Card.Surface = SpriteCard0[ScratchCard.CountSprite].transform;
            //var sprite = SpriteCard0[ScratchCard.CountSprite].GetComponent<SpriteRenderer>();
            //sprite.sprite = ScratchSurfaceSprite;
            //sprite.material = scratchSurfaceMaterial;
        }
		else if (RenderType == ScratchCardRenderType.CanvasRenderer)
		{
            ...
            //var image = ImageCard.GetComponent<SpriteRenderer>();
            //image.sprite = ScratchSurfaceSprite;
            //image.material = scratchSurfaceMaterial;
        }
