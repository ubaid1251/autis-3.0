	...
	private bool isWebgl = true;
		...
		public void Update()
		{
			...
			else
			{
				...
				{
					//Debug.Log(Camera.main.WorldToScreenPoint(scratchCard.PointedPos.position));

					//TryScratch(0, Input.mousePosition);
						TryScratch(0, Camera.main.WorldToScreenPoint(scratchCard.PointedPos.position));
				}
